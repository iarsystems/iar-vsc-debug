...
export namespace BreakpointCommands {
    export function registerCommands(context: vscode.ExtensionContext, sessionTracker: DebugSessionTracker) {
        ...
        const registerCommand = (commandName: string, dapRequest: CustomRequest.Names, breakpointType: SettingsConstants.BreakpointTypeValues) => {
        ...
        registerCommand("iar.useAutoBreakpoints", CustomRequest.Names.USE_AUTO_BREAKPOINTS, SettingsConstants.BreakpointTypeValues.AUTO);
        registerCommand("iar.useHardwareBreakpoints", CustomRequest.Names.USE_HARDWARE_BREAKPOINTS, SettingsConstants.BreakpointTypeValues.HARDWARE);
        registerCommand("iar.useSoftwareBreakpoints", CustomRequest.Names.USE_SOFTWARE_BREAKPOINTS, SettingsConstants.BreakpointTypeValues.SOFTWARE);
