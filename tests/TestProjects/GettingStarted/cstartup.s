...
;;
        ...
        SECTION	SVC_STACK0:DATA:NOROOT(3)
        SECTION	UND_STACK0:DATA:NOROOT(3)
        SECTION	ABT_STACK0:DATA:NOROOT(3)
        SECTION	IRQ_STACK0:DATA:NOROOT(3)
        SECTION	FIQ_STACK0:DATA:NOROOT(3)
        SECTION	CSTACK0:DATA:NOROOT(3)
        SECTION	SVC_STACK1:DATA:NOROOT(3)
        SECTION	UND_STACK1:DATA:NOROOT(3)
        SECTION	ABT_STACK1:DATA:NOROOT(3)
